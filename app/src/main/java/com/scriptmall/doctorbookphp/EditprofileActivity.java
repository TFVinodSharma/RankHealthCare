...
//        getCityname1(state);
    ...
    private void getCountryname() {
        loading = ProgressDialog.show(EditprofileActivity.this,"Please wait...","Fetching...",false,false);
...
//                        Toast.makeText(EditprofileActivity.this,"country", Toast.LENGTH_LONG).show();
    ...
    private void showJSONspinner(String response) {
        if (!response.toLowerCase().trim().equals("failure")) {
            ...
            spincountry1.setAdapter(new ArrayAdapter<String>(EditprofileActivity.this, R.layout.simple_spinner_item, countrylist));
            spincountry1.setSelection(new ArrayAdapter<String>(EditprofileActivity.this, R.layout.simple_spinner_item, countrylist).getPosition(country));
        }
    }
...
//                        Toast.makeText(EditprofileActivity.this,"state",Toast.LENGTH_LONG).show();
    ...
    private void showJSONStatespinner(String response) {
        if (!response.toLowerCase().trim().equals("failure")) {
            ...
            spinstate1.setAdapter(new ArrayAdapter<String>(EditprofileActivity.this, R.layout.simple_spinner_item, stateList));
            spinstate1.setSelection(new ArrayAdapter<String>(EditprofileActivity.this, R.layout.simple_spinner_item, stateList).getPosition(state));
        }
    }
...
//                        Toast.makeText(EditprofileActivity.this,"city",Toast.LENGTH_LONG).show();
    ...
    private void showJSONCityspinner(String response) {
        if (!response.toLowerCase().trim().equals("failure")) {
            ...
            spincity1.setAdapter(new ArrayAdapter<String>(EditprofileActivity.this, R.layout.simple_spinner_item, cityList));
            spincity1.setSelection(new ArrayAdapter<String>(EditprofileActivity.this, R.layout.simple_spinner_item, cityList).getPosition(city));
        }
    }
    void insertdb(){
