...
public class EditDoctorPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_doctor_photo);
...
//        image=getStringImage(bitmap);
        loading = ProgressDialog.show(EditDoctorPhotoActivity.this,"Please wait...","Fetching...",false,false);
...
//                        Toast.makeText(EditProfileActivity.this,response,Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditDoctorPhotoActivity.this,error.toString(),Toast.LENGTH_LONG).show();
...
//                super.onBackPressed();
                Intent intent = new Intent(getApplicationContext(), ProfileDoctorActivity.class);
