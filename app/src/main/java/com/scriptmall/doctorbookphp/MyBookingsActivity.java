...
public class MyBookingsActivity extends AppCompatActivity {
    ...
    String lname,bdate,btime,bstatus,bid,uid;
...
//        recyclerView.setLayoutManager(new GridLayoutManager(this, getGridSpanCount(this)));
        ...
        mAdapter = new MyBookingsAdapter(this,reviewList);
...
////                        Toast.makeText(getApplicationContext(), "Connection available", Toast.LENGTH_SHORT).show();
    ...
    public void prepairData(){
        Book near=new Book("Gowtham Kumar","0","10.00 AM","07-12-2017");
        reviewList.add(near);
        near=new Book("Sivakumar","3","12.00 PM","01-11-2017");
        reviewList.add(near);
        near=new Book("Sathish","1","9.30 AM","10-11-2017");
        reviewList.add(near);
        near=new Book("Jeeva","1","4.30 PM","12-10-2017");
        reviewList.add(near);
        near=new Book("Lokeshbabu","2","6.30 PM","29-09-2017");
        reviewList.add(near);
    ...
    public void getData() {
        ...
        loading = ProgressDialog.show(MyBookingsActivity.this,"Please wait...","Fetching...",false,false);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.MY_APPOIRNTMENT_URL,
...
//            recyclerView.setLayoutManager(new GridLayoutManager(this, MainActivity.getGridSpanCount(this)));
            mAdapter = new MyBookingsAdapter(this, recyclerView, reviewList);
            recyclerView.setAdapter(mAdapter);
//
        }
